...
# Pris på towers
@export var farmer_cost = 50
@export var defender_cost = 100
...
func _ready():
	...
	# Opdaterer penge tekst fra start
	update_money_text()
...
func place_tower(mouse_pos):
	...
	# Bruges til at tjekke om feltet allerede er optaget
